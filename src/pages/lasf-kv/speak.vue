<template>
    ...
    <el-form :inline="true" class="demo-form-inline" size="mini" style="text-align:right;">
        ...
        <el-form-item>
            ...
            <router-link :to="{ path: '/home/skill/detail/sersion',query:{index:this.index,d_info:this.d_info,d_mint:this.d_mint,d_title:this.d_title,d_url:this.d_url}}">
    ...
    <div class="table-box">
        ...
        <el-form :label-position="'left'" label-width="80px" :rules="editRules" :model="currentItem" ref="currentItem">
            <el-form-item label="说法" prop="ruleDes">
...
export default {
  ...
  data() {
    return {
      ...
      addRules:{
        ruleDes:[{ required: true, message: '请输入说法名称', trigger: 'change' }],
        state:[{ required: true, message: '请选择是否强制匹配', trigger: 'change' }]
      },
      editRules:{
        ruleDes:[{ required: true, message: '请输入说法名称', trigger: 'blur' }],
  ...
  created() {
        ...
        this.getList();
        console.log(this.d_mint,this.d_url)
  },
  methods: {
