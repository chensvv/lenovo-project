<template>
    ...
    <div class="table-box">
        ...
        <el-form :label-position="'left'" label-width="80px" :rules="editRules" :model="currentItem" ref="currentItem">
            <el-form-item label="说明" prop="ruleDes">
                <el-input type="text" v-model="currentItem.ruleDes" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="答案" prop="ser" class="ser_t">
                <el-input type="textarea" v-model="currentItem.ser" auto-complete="off"></el-input>
            </el-form-item>
        </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      addRules:{
        ruleDes: [{ required: true, message: '请输入答案说明', trigger: 'change' }],
        ser: [{ required: true, message: '请输入答案', trigger: 'change' }],
      },
      editRules:{
