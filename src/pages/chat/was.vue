...
export default {
    ...
    data() {
        return {
            ...
            addRules:{
                classnames:[{ required: true, message: '请输入网站名称add', trigger: 'change' }],
                shuof:[{ required: true, message: '请输入说法', trigger: 'change' }],
                mobile_url:[{ required: true, message: '请输入手机网址', trigger: 'change' }],
            },
            editRules:{
