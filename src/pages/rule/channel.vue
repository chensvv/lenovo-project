<template>
  <div class="table channel">
    ...
    <el-form :inline="true" ref="searchItem" :model="searchItem" class="demo-form-inline search_box" size="mini">
      <el-form-item label="中文名称" prop="q">
        <el-input v-model.trim="searchItem.q" clearable></el-input>
      </el-form-item>
      <el-form-item class="sub-btn">
        <el-button type="primary" @click="onSubmit" :loading="seaBtnLoading">查询</el-button>
        <el-button @click="resetForm('searchItem')">重置</el-button>
        <el-button size="mini" @click="handleAdd()" v-has="'qa:channelAdd'">添加</el-button>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      addRules:{
        q:[{ required: true, message: '请输入数据名称', trigger: 'change' }],
        
      },
      editRules:{
        q:[{ required: true, message: '请输入数据名称', trigger: 'blur' }],  
      },
      editVisible: false,
      addVisible: false,
      // 分页
