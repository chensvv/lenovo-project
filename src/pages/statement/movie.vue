  ...
  <div class="table height-85">
    ...
    <el-form :inline="true" ref="searchItem" :model="searchItem" label-width="90px" class="demo-form-inline height50 width130" size="mini">
      ...
      <div class="form-btn">
        ...
        <el-button size="mini" @click="buildAIML()" :loading="AIMLBtnLoading" v-has="'movie:pub'">生成AIML</el-button>
        <el-button size="mini" @click="handleAdd()" v-has="'movie:save'">添加</el-button>
      </div>
    ...
    <div class="table-box">
      <el-table
          ...
          <el-table-column label="操作" align="center" min-width="180" v-if="btnshow">
              <template slot-scope="scope">
                <el-popconfirm
                    :hide-icon="true"
